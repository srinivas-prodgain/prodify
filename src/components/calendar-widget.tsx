...
const PLATFORM_ICON = {
    "Google Meet": <svg width="25px" height="25px" viewBox="-3.2 -3.2 38.40 38.40" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
    ...
    "Zoom": <svg width="22px" height="22px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    "Microsoft Teams": <svg width="22px" height="22px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
                            ...
                            <div key={event.id} className="rounded-xl p-4 bg-[#f5f6ff] md:p-7">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 bg-white py-1 px-2 md:px-3 rounded-full">
                                        {PLATFORM_ICON[event.platform as keyof typeof PLATFORM_ICON]}
                                        ...
                                        <div className="flex items-center justify-center bg-white rounded-full">
                                            {event.attendees.slice(0, 5).map((attendee, i) => (
                                                i < 4 ? (
                                                    <div
                                                        key={i}
                                                        className={`text-sidebar-primary-foreground flex aspect-square items-center justify-center rounded-full relative bg-[#ded1f1] size-8 overflow-hidden border-[2.7px] border-white ${i > 0 ? 'ml-[-8px]' : ''}`}
                                                    >
                                                        <Image
                                                            src={attendee.avatar || ''}
                                                            alt={attendee.name}
                                                    ...
                                                    <div
                                                        key={i}
                                                        className={`text-sidebar-primary-foreground flex aspect-square items-center justify-center rounded-full relative bg-[#6c39d3] size-8 overflow-hidden border-0 ${i > 0 ? 'ml-[-8px]' : ''}`}
                                                    >
