        ...
        <Card className="rounded-xl border py-4 shadow-none">
            <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-2">
                    <Briefcase className="text-brand-purple-light size-5" strokeWidth={2} />
                    <CardTitle className="text-lg font-[580]">Projects</CardTitle>
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="sm" className="text-[0.75rem] text-gray-medium hover:bg-purple-50 hover:text-black flex items-center gap-0">
                                {selectedFilter}
